...
public class CarExpFlagEncoder extends AbstractFlagEncoder {
    ...
    public CarExpFlagEncoder(PMap properties) {
    ...
    public CarExpFlagEncoder(String propertiesStr) {
        this(new PMap(propertiesStr));
    }

    public CarExpFlagEncoder(int speedBits, double speedFactor, int maxTurnCosts) {
    ...
    /**
     * Dieter: Method actually deprecated, but is used to dynamically update the weights based on number of traversals of edges
     */

    public void setSpeed(IntsRef edgeFlags, double speed) {
...
/*
        ...
        if (speed > getMaxSpeed())
            speed = getMaxSpeed();
*/ // Dieter: Use whatever speed value is passed down....
    ...
    public EncodingManager.Access getAccess(ReaderWay way) {
        ...
        // Dieter: DC Experiment mods - given a set of osm ids, make those edges impassable...
        //George Washington Bridge...
        long[] blocked = new long[]{619876894, 50560692, 6058637, 619876895};
