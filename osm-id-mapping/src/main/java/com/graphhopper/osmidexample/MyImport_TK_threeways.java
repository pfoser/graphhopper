 ...
 */
public class MyImport_TK_threeways {
...
// where to store graphhopper files?
        ...
        graphHopper.setEncodingManager(EncodingManager.create("car_exp")); //Dieter create this one... allows for blocked edges
        ...
        try (BufferedReader csvReader = new BufferedReader(new FileReader("./data/od_coords_3ways.csv"))) {
            ...
            try {
                ...
                encoder = graphHopper.getEncodingManager().getEncoder("car"); //get the car flagEncoder for this gh instance. FE capture the weights of the graph!
