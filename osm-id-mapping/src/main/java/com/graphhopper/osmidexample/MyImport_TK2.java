...
// where to store graphhopper files?
        ...
        try (BufferedReader csvReader = new BufferedReader(new FileReader("./data/estimateMode_trct2trct(clostVoro)_pbf_newBuffer.csv"))) {

            File route_file = new File("./data/od_tk2_routes.csv"); // output file for routes
            try {
                ...
                while ((row = csvReader.readLine()) != null) {
                    ...
                    List<Path> paths = graphHopper.calcPaths(new GHRequest(Float.parseFloat(data[3]), Float.parseFloat(data[2]), Float.parseFloat(data[5]), Float.parseFloat(data[4])).
                        ...
                        for (EdgeIteratorState edge : path0.calcEdges()) {
                            ...
                            try {
                                ...
                                if (old_osmway != osm_way) {
                                    ...
                                    String[] segment = {String.valueOf(count), vInfo, String.valueOf(edgeId), String.valueOf(osm_way), data[12]};
