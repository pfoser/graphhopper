...
// where to store graphhopper files?
        ...
        //read file
        try (BufferedReader csvReader = new BufferedReader(new FileReader("./data/od_coords.csv"))) {

            File route_file = new File("./data/od_routes.csv"); // output file for routes
            try {
                ...
                while ((row = csvReader.readLine()) != null) {
                    ...
                    List<Path> paths = graphHopper.calcPaths(new GHRequest(Float.parseFloat(data[1]), Float.parseFloat(data[0]), Float.parseFloat(data[3]), Float.parseFloat(data[2])).
                        ...
                        for (EdgeIteratorState edge : path0.calcEdges()) {
                            ...
                            try {
                                ...
                                if (old_osmway != osm_way) {
                                    ...
                                    String[] segment = {String.valueOf(count), vInfo, String.valueOf(edgeId), String.valueOf(osm_way), data[4]};
